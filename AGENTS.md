...
# Swytchcode Agent Contract (Codex)
...
Codex is **compiling against Swytchcode, not exploring it** - if something doesn't exist, compilation must fail. Failing fast is correct behavior.
